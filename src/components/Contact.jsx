  ...
  return (
    <div id='contact' className='max-w-[1140px] m-auto w-full p-4 py-16'>
      ...
      <div className='grid md:grid-cols-2'>
        <img
          src='https://source.unsplash.com/random/contact'
          alt='/'
        ...
        <form>
          <div className='grid grid-cols-2'>
            ...
            <textarea
              ...
              rows='10'
            ></textarea>
            <button className='col-span-2 m-2 px-4 py-2 border bg-gradient-to-r from-[var(--primary-dark)] to-[var(--primary-light)] text-white '>
              Submit
            </button>
          </div>
        </form>
